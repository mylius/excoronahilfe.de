        ...
        <div class="md-layout">
          <div class="md-layout-item md-size-50 md-small-size-70 md-xsmall-size-100">
            ...
            <h4>
              ...
              <b>ein Netzwerk von Covid-19 Gesundeten</b> auf, die jetzt immun sind. Wir leisten Hilfe, Beratung und Vermittlung, damit ihr besonders effektiv helfen können. Mach mit und lasst uns gemeinsam helfen!
              <br />
        ...
        <div class="container">
          <div class="md-layout">
            <div class="md-layout-item md-size-66 md-xsmall-size-100 mx-auto">
              ...
              <h4 class="text-center description">Melde dich bei uns!</h4>
...
export default {
  ...
  mounted(){
    ...
    this.getLocations();
    L.marker([13.76, 100.5]).addTo(myMap);
  ...
  methods: {
    ...
    async retrieve_data() {
      this.loading = true;
      await axios.get(API_CASE_NUMBER_URL).then(response => {
        this.casenumber = response.data.recovered;
      });
    },
    async getLocations() {
       var data = await dataservice.getLocations().then(data => {
        return data;
      });
      for(var value of data){
           L.marker([value.location.coordinates[1],value.location.coordinates[0]]).addTo(this.map)
        }
    },
